...
public class FindQueryResourcesTest {
    ...
    private ResourceResolver setupResourceResolver;
    private Resource resource1;
    private Resource resource2;

    @Before
    public void setUp() throws Exception {
        setupResourceResolver = createResourceResolver();

        MockHelper.create(setupResourceResolver)
            .resource("/resource1").p("prop1", "value1")
            .resource("/resource2").p("prop1", "value2")
            .commit();
        resource1 = setupResourceResolver.getResource("/resource1");
        resource2 = setupResourceResolver.getResource("/resource2");
        setupResourceResolver.commit();
    }
    ...
    protected ResourceResolver createResourceResolver_addFindResourceHandlers(MockFindResourcesHandler... handlers) throws LoginException {
        // set handler directly on resource resolver
